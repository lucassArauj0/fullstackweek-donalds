...
CREATE TABLE "Order" (
    ...
    "consumptionMethod" "ComsumptionMethod" NOT NULL,
    "reataurantId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_reataurantId_fkey" FOREIGN KEY ("reataurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
